...
//	}
	...
	//	source.setUrl("jdbc:h2:tcp://localhost/~/test3;INIT=runscript from 'classpath:/create.sql'");
	...
	/**
	 * The class that handles all tokens is the DefaultTokenServices – and has to be
...
// lub @ConfigurationProperties("app.datasource") 
